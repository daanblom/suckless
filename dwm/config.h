...
static const char col_cyan[]        = "#DCA561";
...
static const char *dmenucmd[] = { "dmenu_run", "-h", "70", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_cyan, "-sf", col_gray4, NULL };
static const char *termcmd[]  = { "kitty", NULL };
static const char scratchpadname[] = "scratchpad";
static const char *scratchpadcmd[] = { "st", "-t", scratchpadname, "-g", "120x34", NULL };
static const char *scratchpadprofanity[] = { "st", "-t", scratchpadname, "-e", "ranger", "-g", "120x34", NULL };
...
static const Key keys[] = {
	...
	{ MODKEY,                       XK_c,      togglescratch,  {.v = scratchpadprofanity } },
